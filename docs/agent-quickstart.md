...
6. Record the score, invariant probe output, public audit output, baseline
   delta, stress diagnostics, selection hash, changed files, and failure modes.
...
- Local bundle validation passes against freshly rerun public score, probes, source bundle, and search ledger.
