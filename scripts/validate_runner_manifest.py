...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate a Limes DataForge trusted-runner manifest.")
    parser.add_argument("--input", required=True, help="Trusted-runner manifest JSON.")
    parser.add_argument(
        "--contract",
